...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::allocator_type _associative_vector::get_allocator() const { return (inherited::get_allocator()); }
...
TEMPLATE_SPECIALIZATION
IC void _associative_vector::swap(self_type& right) { inherited::swap(right); }
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::value_compare _associative_vector::value_comp() const { return (value_compare(key_comp())); }
